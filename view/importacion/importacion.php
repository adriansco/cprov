...
<div class="table-responsive">
    <table class="table table-striped zero-configuration table-hover" id="tabla" style="width: 100%;"">
        ...
        <tbody>
            <?php foreach ($this->model->fetchDocumentos() as $r) : ?>
                <tr>
                    <td><?php echo $r->name; ?></td>
                    <td><?php echo $r->date; ?></td>
                    <td class="text-center">
                        <a class="btn btn-success" href="?c=importacion&a=fetchContenedores&id=<?php echo $r->idproveedor; ?>" rel="noopener noreferrer"><i class="icon align-middle lar la-folder"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
